...
export const contentAr: Content = {
  ...
  hero: {
    ...
    namePrefix: 'أنا',
    name: 'حسن أحمد',
    role: ['باحث معلوماتية حيوية',
  'علوم البيانات للصحة العامة',
  'تحليل البيانات الجينومية'],
    description: 'أعمل في مجال يجمع بين المعلوماتية الحيوية وعلم البيانات، وأطبق مناهج تعتمد على البيانات في مجالات الصحة العامة والتحديات البيئية والسلامة الرقمية في منطقة الشرق الأوسط وشمال أفريقيا.',
    btnAbout: 'عني',
