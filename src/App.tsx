      ...
      <main className="flex-grow z-10">
        ...
        <section id="experience" className="py-20 bg-gray-900/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {/* Central Line Container - THIS DICTATES THE WIDTH */}
        ...
        {/* CERTIFICATIONS SECTION - FIXED SIZE & SPACING */}
        {/* Changed bg to bg-gray-900/50 to match experience, removed pt-20 */}
        <section id="certifications" className="pb-20 pt-0 bg-gray-900/50">
            {/* Changed max-w-7xl to max-w-4xl to match the timeline width above it */}
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Changed grid cols to be better suited for narrower container (2 cols on lg instead of 4) */}
