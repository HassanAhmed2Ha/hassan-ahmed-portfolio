...
// --- ANIMATED BACKGROUND COMPONENT (UPDATED WITH STRONGER CONNECTIONS) ---
const ParticleBackground = () => {
  ...
  useEffect(() => {
    ...
    const connectionDistance = 140; // Increased distance
    const baseOpacity = 0.4; // Stronger line opacity
      ...
      particles.forEach((p, i) => {
        ...
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < connectionDistance) {
            ctx.beginPath();
            const opacity = baseOpacity * (1 - dist / connectionDistance);
