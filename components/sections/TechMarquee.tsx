      ...
      <div className="flex w-max group">
        ...
        <div className="flex animate-marquee group-hover:[animation-play-state:paused]">
          {data.map((item, idx) => (
            <div
              key={`${item.name}-${idx}`}
              className="flex-shrink-0 flex flex-col items-center justify-center w-40 h-40 mx-4 rounded-2xl bg-neutral-900 border border-neutral-800 transition-all duration-300 hover:scale-110 hover:border-cyan-500/50 hover:shadow-[0_0_25px_2px_rgba(0,195,255,0.35)] hover:z-20 cursor-pointer relative"
            >
