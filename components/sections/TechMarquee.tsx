    ...
    <section className="w-full py-10 bg-primary/90 overflow-hidden relative border-y border-white/10">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex w-max">
          <div className="flex items-center gap-3.5 animate-marquee [animation-duration:30s]">
            {data.map((item, idx) => (
              <div
          ...
          <div
            className="flex items-center gap-3.5 animate-marquee [animation-duration:30s]"
            aria-hidden="true"
          >
            {data.map((item, idx) => (
              <div
        ...
        <div className="flex w-max">
          <div className="flex items-center gap-3.5 animate-marquee [animation-duration:30s] [animation-direction:reverse]">
          ...
          <div
            className="flex items-center gap-3.5 animate-marquee [animation-duration:30s] [animation-direction:reverse]"
            aria-hidden="true"
          >
            {reversedData.map((item, idx) => (
              <div
